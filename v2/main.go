// v2: use a shared abort function
// https://play.golang.org/p/LDuyBGXGeyg
...
func (s Shopper) Drive(fuelRequired int) (Shopper, error) {
	s.Fuel -= fuelRequired
	if s.Fuel < 0 {
...
func (s Shopper) BuyEggs(howMany int) (Shopper, error) {
...
// FatalIfErrNotNil stops the program if err is not nil.
